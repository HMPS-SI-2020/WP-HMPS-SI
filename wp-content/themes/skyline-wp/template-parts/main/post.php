<div data-colibri-id="16-m1" class="style-66 style-local-16-m1 h-overflow-hidden position-relative">
                ...
                <div data-colibri-id="16-m31" class="style-101 style-local-16-m31 position-relative">
                  <div class="h-global-transition-all blog-post-comments">
                    <?php colibriwp_post_comments(array (
                      'none' => __('No responses yet', 'skyline-wp'),
                      'one' => __('One response', 'skyline-wp'),
                      'multiple' => __('{COMMENTS-COUNT} Responses', 'skyline-wp'),
