 ...
 *
 * @method static prefixed_add_action( string $tag, callable $function_to_add, $priority = 10, $accepted_args = 1 )
 * @method static prefixed_add_filter( string $tag, callable $function_to_add, $priority = 10, $accepted_args = 1 )
 * @method static prefixed_do_action( string $tag, ...$args )
 * @method static mixed prefixed_apply_filters( string $tag, $value, ...$args )
 */
class ThemeHooks {
