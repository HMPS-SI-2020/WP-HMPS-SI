<?php namespace ExtendBuilder; load_file_value('partial_data', array (
  ...
  array (
    ...
    'data' => 
    array (
      'json' => '{"name":"hop-footer","children":[{"name":"hop-section","props":{"anchor":false,"name":"Copyright","attrs":{"id":"copyright"}},"children":[{"name":"hop-row","children":[{"name":"hop-column","style":{"descendants":{"outer":{"columnWidth":{"type":"custom","custom":{"value":100,"unit":"%"}}}}},"children":[{"name":"hop-copyright","slot":null,"parentId":"11-f4","index":1,"id":"11-f5","partialId":11,"styleRef":65,"type":"footer"}],"id":"11-f4","parentId":"11-f3","partialId":11,"styleRef":64,"type":"footer"}],"parentId":"11-f2","index":0,"id":"11-f3","partialId":11,"styleRef":63,"type":"footer"}],"id":"11-f2","parentId":"11-f1","partialId":11,"styleRef":62,"type":"footer"}],"id":"11-f1","ui":{"isSelected":false,"isHovered":false},"type":"footer","partialId":11,"styleRef":61}',
      'meta' => 
      array (
        'styleRefs' => 
        array (
      ...
      'html' => '<div data-enabled="true" data-colibri-component="footer-parallax" data-colibri-id="11-f1" class="page-footer style-61 style-local-11-f1 position-relative">
  <!---->
...
',
    ...
    64 => 
    array (
      'desktop' => '.style-64 > .h-y-container > *:not(:last-child) {
  margin-bottom: 0px;
}
#colibri .style-64 {
  text-align: center;
